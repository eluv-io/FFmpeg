...
#if !defined _ANDROID && !defined MSVC_BUILD
...
#define NI_NO_CHECK_TS_NVME_CMD_OP (-1)
...
typedef enum _nvme_query_xcoder_instance_subtype
{
  ...
  nvme_query_xcoder_instance_get_end_of_output = 0x0005, // unused
...
typedef enum _nvme_config_xcoder_config_instance_subtype
{
  ...
  nvme_config_xcoder_config_update_enc_params = 0x0008, // unused
  nvme_config_xcoder_config_set_enc_frame_params = 0x0009, // unused
  nvme_config_xcoder_config_set_dec_packet_size = 0x000c,
  nvme_config_xcoder_config_init_buf_params = 0x000d,
  nvme_config_xcoder_config_recycle_buf_params = 0x000e,
  nvme_config_xcoder_config_read_frame_idx = 0x000f
...
/*!******************************************************************************
 * \brief  Check f/w error return code, and if it's a fatal one return NI_RETCODE_FAILURE.
 ...
 * \return
 *******************************************************************************/
int ni_nvme_enumerate_devices(char ni_devices[][MAX_DEVICE_NAME_LEN], int max_handles);
...
#define NI_INSTANCE_TYPE_OFFSET       18
#define NI_SESSION_ID_OFFSET          19
#define NI_HW_DESC_OFFSET             26
...
#define HIGH_OFFSET_IN_4K(hw,sid,instance)  (((hw<<(NI_HW_DESC_OFFSET-NI_INSTANCE_TYPE_OFFSET))|((sid & 0x7FUL)<<1)|(instance))<<NI_INSTANCE_TYPE_OFFSET)  // 1024MB
...
#define QUERY_INSTANCE_EOS_R(sid,instance)          HIGH_OFFSET_IN_4K(0,sid,instance) + CTL_OFFSET_IN_4K(GAP(nvme_admin_cmd_xcoder_query),  \
...
#define CONFIG_INSTANCE_Flush_W(sid,instance)       HIGH_OFFSET_IN_4K(0,sid,instance) + CTL_OFFSET_IN_4K(GAP(nvme_admin_cmd_xcoder_config),  \
...
#define CONFIG_INSTANCE_SetEncFramePara_W(sid,instance) HIGH_OFFSET_IN_4K(0,sid,instance) + CTL_OFFSET_IN_4K(GAP(nvme_admin_cmd_xcoder_config),  \
