 ...
 *  \return
 *******************************************************************************/
int ni_rsrc_enumerate_devices(char ni_devices[][MAX_DEVICE_NAME_LEN],
                              int max_handles)
{
...
void ni_rsrc_get_one_device_info (ni_device_info_t * p_device_info)
{
  ...
  p_coder_info_dst = (ni_device_info_t *)mmap(0, sizeof(ni_device_info_t), PROT_READ | PROT_WRITE,
                                              MAP_SHARED, shm_fd, 0);
