...
#define NI_INVALID_HW_FRAME_IDX -3 // fw default invalid value
#define NI_INVALID_HW_META_IDX  -5 // fw hw meta index
...
#define MAX_NUM_FRAMEPOOL_HWAVFRAME 64
...
typedef enum
{
  ...
  PIC_TYPE_FORCE_IDR = 3,           /*!*< force IDR frame when encoding */

  PIC_TYPE_IDR = 5,                  /*!*< H.264/H.265 IDR picture */
  PIC_TYPE_CRA = 6,                  /*!*< H.265 CRA picture */
...
*/
typedef enum _ni_codec_hw_actions
{
  NI_CODEC_HW_NONE = 0,
...
typedef struct _ni_custom_sei
{
  ...
  ni_custom_sei_location_t custom_sei_loc;
  uint32_t custom_sei_size;
  uint8_t custom_sei_data[NI_MAX_CUSTOM_SEI_SZ];
}ni_custom_sei_t;

typedef struct _ni_all_custom_sei
{
  uint8_t custom_sei_cnt;
  ni_custom_sei_t ni_custom_sei[NI_MAX_CUSTOM_SEI_CNT];
}ni_all_custom_sei_t;
...
typedef enum _ni_session_run_state
{
  ...
  SESSION_RUN_STATE_QUEUED_FRAME_DRAINING = 3,
...
typedef struct _ni_serial_num_t
{
  uint8_t ai8Sn[20];
} ni_serial_num_t;
...
typedef struct _ni_session_context
{
  ...
  ni_all_custom_sei_t *pkt_custom_sei[NI_FIFO_SZ];
  ...
  ni_serial_num_t d_serial_number; /*Serial number of card (dec or uploader) in use*/
  ni_serial_num_t e_serial_number; /*Serial number of card (enc) in use*/
...
#define NI_CMN_PARAM_SAVE_PKT                       "savePkt"
...
//ni_decoder_input_params defs
#define NI_DEC_PARAM_OUT                          "out"

typedef struct _ni_decoder_input_params
{
  int hwframes;
...
typedef struct _ni_packet
{
  ...
  ni_all_custom_sei_t *p_all_custom_sei;
...
// 24 bytes
typedef struct _ni_hwframe_surface
{
  ...
  int8_t seq_change;
  int8_t src_cpu;//unused
  int8_t rsc[8];
}ni_hwframe_surface_t;
 ...
 *                          NI_RETCODE_ERROR_MEM_ALOC
 ******************************************************************************/
LIB_API ni_retcode_t ni_frame_buffer_alloc(ni_frame_t *pframe,
                                           int video_width,
                                           int video_height,
                                           int alignment,
                                           int metadata_flag,
...
/*!*****************************************************************************
  ...
  *                          NI_RETCODE_ERROR_MEM_ALOC
  *****************************************************************************/
LIB_API ni_retcode_t ni_frame_buffer_alloc_v3(ni_frame_t *pframe,
                                              int video_width,
                                              int video_height,
                                              int linesize[],
                                              int alignment,
 ...
 *                        NI_RETCODE_INVALID_PARAM
 ******************************************************************************/
LIB_API ni_retcode_t ni_encoder_init_default_params(ni_encoder_params_t *p_param,
                                                    int fps_num,
                                                    int fps_denom,
                                                    long bit_rate,
                                                    int width,
 ...
 *                        NI_RETCODE_INVALID_PARAM
 ******************************************************************************/
LIB_API ni_retcode_t ni_decoder_init_default_params(ni_encoder_params_t *p_param,
                                                    int fps_num,
                                                    int fps_denom,
                                                    long bit_rate,
                                                    int width,
...
*                        NI_RETCODE_INVALID_PARAM
*******************************************************************************/
LIB_API ni_retcode_t ni_decoder_params_set_value(ni_encoder_params_t* p_params,
                                                 const char* name,
                                                 char* value);
...
*                        NI_RETCODE_INVALID_PARAM
******************************************************************************/
LIB_API ni_retcode_t ni_encoder_params_set_value(ni_encoder_params_t * p_params,
                                                 const char *name,
                                                 const char *value,
...
*******************************************************************************/
LIB_API ni_retcode_t ni_encoder_params_check(ni_encoder_params_t* p_params,
 ...
 *                        NI_RETCODE_INVALID_PARAM
 ******************************************************************************/
LIB_API ni_retcode_t ni_encoder_gop_params_set_value(ni_encoder_params_t * p_params,
                                                     const char *name,
                                                     const char *value);
...
*                     NI_RETCODE_ERROR_NVME_CMD_FAILED
*******************************************************************************/
LIB_API ni_retcode_t ni_device_handle_map_SN(ni_device_handle_t device_handle,
...
*          On failure    NI_RETCODE_INVALID_PARAM
*******************************************************************************/
LIB_API ni_retcode_t ni_decode_buffer_free(ni_hwframe_surface_t* surface,
                                           ni_device_handle_t device_handle);
 ...
 *  \param[in]  device_type         only NI_DEVICE_TYPE_SCALER supported now
 *
 ...
 *
 *******************************************************************************/
LIB_API ni_retcode_t ni_frame_buffer_alloc_v4(ni_frame_t *pframe,
                                              int pixel_format,
                                              int video_width,
                                              int video_height,
                                              int linesize[],
