...
Contents:
- readme.txt
- Visual Studio 2015 solution/project files (under VS2015_sln_proj directory) 
...
Driver building:
- To open nvme solution within Visual Studio 2015 build environment, you may simply
  double-click the released solution file (nvme.sln) under VS2015_sln_proj directory
  if you have Visual Studio 2015 installed properly.
- After nvme solution is built successfully, the resulted 64-bit binary is saved 
  under x64 directory and 32-bit binary in VS2015_sln_proj\Win7(8/8.1/10)Release(Debug).
- If you need check build driver, after opening the solution file within Visual
  Studio 2015, right click the solution and select "Properties" to bring up
...
Limitations:
- The driver supports Windows 7/8/8.1/10, Server 2008 R2/2012/2012 R2/2016 RTM.
